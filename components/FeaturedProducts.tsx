...
const products: Product[] = [
    { id: 1, title: 'Boss Perfume', price: '100.00', image: '/images/perfume.png' },
    { id: 2, title: 'Apple Watch', price: '800.00', image: '/images/watch2.png' },
    { id: 3, title: 'T-shirt', price: '49.00', image: '/images/shirt1.png' },
    { id: 4, title: 'MacBook', price: '1400.00', image: '/images/macbook.png' },
    { id: 5, title: 'Nike Sport', price: '50.00', image: '/images/shoe1.png' },
    { id: 6, title: 'Apple Watch', price: '800.00', image: '/images/watch2.png' },
    { id: 7, title: 'T-shirt', price: '49.00', image: '/images/shirt1.png' },
    { id: 8, title: 'MacBook', price: '1400.00', image: '/images/macbook.png' },
];
        ...
        <section className="bg-white py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center mb-8">
                    <h2 className="text-base lg:text-3xl font-bold text-gray-900">Featured Products</h2>
