                        ...
                        <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-[30px] gap-5">
                            <div data-aos="fade-up" className="item w-full">
                                <div
                                    ...
                                    style={{
                                        background: `url(/images/sallers-cover-1.png) no-repeat`,
                            ...
                            <div data-aos="fade-up" className="item w-full">
                                <div
                                    className="w-full sm:h-[328px] sm:p-[30px] p-5"
                                    style={{
                                        background: `url(/images/sallers-cover-6.png) no-repeat`,
                                        backgroundSize: "cover",
                                    }}
                                >
                                    <div className="flex sm:flex-row flex-col-reverse sm:items-center justify-between w-full h-full">
                            ...
                            <div data-aos="fade-up" className="item w-full">
                                <div
                                    className="w-full sm:h-[328px] sm:p-[30px] p-5"
                                    style={{
                                        background: `url(/images/sallers-cover-2.png) no-repeat`,
                                        backgroundSize: "cover",
                                    }}
                                >
                                    <div className="flex sm:flex-row flex-col-reverse sm:items-center justify-between w-full h-full">
                            ...
                            <div data-aos="fade-up" className="item w-full">
                                <div
                                    className="w-full sm:h-[328px] sm:p-[30px] p-5"
                                    style={{
                                        background: `url(/images/sallers-cover-3.png) no-repeat`,
                                        backgroundSize: "cover",
                                    }}
                                >
                                    <div className="flex sm:flex-row flex-col-reverse sm:items-center justify-between w-full h-full">
                            ...
                            <div data-aos="fade-up" className="item w-full">
                                <div
                                    className="w-full sm:h-[328px] sm:p-[30px] p-5"
                                    style={{
                                        background: `url(/images/sallers-cover-4.png) no-repeat`,
                                        backgroundSize: "cover",
                                    }}
                                >
                                    <div className="flex sm:flex-row flex-col-reverse sm:items-center justify-between w-full h-full">
                            ...
                            <div data-aos="fade-up" className="item w-full">
                                <div
                                    className="w-full sm:h-[328px] sm:p-[30px] p-5"
                                    style={{
                                        background: `url(/images/sallers-cover-5.png) no-repeat`,
                                        backgroundSize: "cover",
                                    }}
                                >
                                    <div className="flex sm:flex-row flex-col-reverse sm:items-center justify-between w-full h-full">
